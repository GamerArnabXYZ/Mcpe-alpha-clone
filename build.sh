...
PACKAGE_NAME="com.gax.voxelforge"
...
# arm64-v8a -> voxelforge-v8a-debug.apk
# armeabi-v7a -> voxelforge-v7a-debug.apk
...
APK_UNSIGNED="$BUILD_DIR/voxelforge-${APK_SUFFIX}-unsigned.apk"
APK_ALIGNED="$BUILD_DIR/voxelforge-${APK_SUFFIX}-aligned.apk"
APK_SIGNED="$BUILD_DIR/voxelforge-${APK_SUFFIX}-debug.apk"
...
echo -e "\nDone. Enjoy VoxelForge on your device!"